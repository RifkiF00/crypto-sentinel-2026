...
export const ROLES = {
  analyst: {
    ...
    allowedMenus: ['dashboard', 'monitoring', 'analysis', 'gnn_metrics_catalog', 'alerts'],
  ...
  compliance_officer: {
    ...
    defaultPage: 'dashboard',
    allowedMenus: [
      'dashboard', 'monitoring', 'analysis', 'gnn_metrics_catalog', 'alerts',
  ...
  admin_regulator: {
    ...
    defaultPage: 'dashboard',
    allowedMenus: ['dashboard', 'analysis', 'gnn_metrics_catalog', 'compliance', 'apolo_governance', 'model_governance'],
...
export const DEMO_USERS = [
  {
    id: 'u1',
    email: 'compliance@sentinel.id',
    password: 'SentinelPass2026!',
    name: 'Compliance Officer / MLRO',
    desc: 'Otorisasi & Pelaporan LTKM ke PPATK',
    role: 'compliance_officer',
    bank: 'Unit Kepatuhan Perbankan',
    nip: 'BKG-MLRO-0089',
  },
  {
    id: 'u2',
    email: 'analyst@sentinel.id',
    password: 'AnalystBjb2026!',
    name: 'AML Investigator & Forensik',
    desc: 'Analisis Alert, Triage & Investigasi GNN',
    role: 'analyst',
    bank: 'Unit AML & Forensik Digital',
