...
export const recentTransactions = [
  ...
  },
  {
    ...
    destination: 'Ahmad Faisal (Bank bjb)',
    walletAddress: null,
    riskScore: 12,
    status: 'approved',
    reason: null,
...
export const alertFeed = [
  {
    ...
    description: 'Budi Santoso (Bank Kuningan 1234****90) memecah dana ke Binance. Total: Rp 750 Juta dicegah oleh Circuit Breaker.',
    time: '2 menit lalu',
  },
  {
    id: 2,
    ...
    description: 'Siti Rahmawati (Bank Kuningan 9876****10) transfer Rp 500 Juta ke Tokocrypto terindikasi klaster anomali GNN.',
    time: '15 menit lalu',
  },
  {
    id: 3,
    ...
    description: 'Ahmad Faisal (Bank bjb 0123****89) mengirim Rp 150 Juta ke Indodax dalam peninjauan analis OJK.',
    time: '28 menit lalu',
  },
  {
    id: 4,
