...
// ==========================================
// Mule Account Detection Data (Real Field Forensic Data)
// ==========================================
export const muleAccountsData = [
  {
    id: 'MULE-001',
    name: 'Bambang Haryanto',
    alias: 'PT Global Logistics (Cangkang)',
    account: '7820194532',
    bank: 'BCA',
    branch: 'KC Jakarta Sudirman (0012)',
    nik: '3174052108870003',
    npwp: '09.234.567.8-015.000',
    address: 'Jl. Jend. Sudirman No. 45, Setiabudi, Jakarta Selatan',
    job: 'Wiraswasta / Ekspedisi Fiktif',
    role: 'Penampung Utama',
    riskScore: 96,
    connectedAccounts: 8,
    totalInflow: 4850000000,
    totalOutflow: 4720000000,
    holdingTime: '3.5 menit (Smurfing)',
    ipAddress: '182.253.12.89 (VPN Active)',
    deviceId: 'DEV-88392-ANDROID14',
    txCount: 47,
    status: 'frozen',
    detectedDate: '2026-05-22',
    strStatus: 'LTKM Diterbitkan (STR-2026/05/8839-PPATK)',
    linkedCryptoWallets: ['0x1a2b...cd34 (Indodax)', '0x5e6f...gh78 (Binance)']
  },
  {
    id: 'MULE-002',
    name: 'Dewi Kartika',
    alias: 'Toko Sembako Raya (Nominee)',
    account: '3310287654',
    bank: 'Mandiri',
    branch: 'KC Surabaya Darmo (0045)',
    nik: '3578024511910002',
    npwp: '12.890.123.4-604.000',
    address: 'Jl. Raya Darmo No. 112, Tegalsari, Surabaya',
    job: 'Pedagang Eceran (Terduga Mule Pasif)',
    role: 'Relay',
    riskScore: 89,
    connectedAccounts: 5,
    totalInflow: 2100000000,
    totalOutflow: 2050000000,
    holdingTime: '5.2 menit',
    ipAddress: '114.124.205.12 (Surabaya)',
    deviceId: 'DEV-10924-IOS17',
    txCount: 32,
    status: 'active',
    detectedDate: '2026-05-25',
    strStatus: 'Proses Draf LTKM PPATK',
    linkedCryptoWallets: ['0x9abc...de12 (TokoCrypto)']
  },
  {
    id: 'MULE-003',
    name: 'Rahmat Hidayat',
    alias: 'CV Nusantara Digital',
    account: '5540198732',
    bank: 'BRI',
    branch: 'KC Bandung Asia Afrika (0088)',
    nik: '3273011403850007',
    npwp: '45.678.901.2-429.000',
    address: 'Jl. Asia Afrika No. 88, Sumur Bandung, Bandung',
    job: 'Jasa Konsultan IT (Perusahaan Shell)',
    role: 'Kolektor',
    riskScore: 91,
    connectedAccounts: 12,
    totalInflow: 6200000000,
    totalOutflow: 6100000000,
    holdingTime: '2.1 menit (High Velocity)',
    ipAddress: '103.213.129.4 (TOR Exit Node)',
    deviceId: 'DEV-99120-WIN11',
    txCount: 68,
    status: 'frozen',
    detectedDate: '2026-05-20',
    strStatus: 'LTKM Terkirim (STR-2026/05/8120-PPATK)',
    linkedCryptoWallets: ['0x3456...ef78 (Pintu)', '0x7890...ab12 (Binance)', '0xbcde...fg34 (KuCoin)']
  },
  {
    id: 'MULE-004',
    name: 'Agus Santoso',
    alias: 'UD Maju Bersama',
    account: '8870654321',
    bank: 'BNI',
    branch: 'KC Medan Barat (0023)',
    nik: '1271031908900001',
    npwp: '78.901.234.5-113.000',
    address: 'Jl. Gatot Subroto No. 201, Medan Petisah, Medan',
    job: 'Distributor Hasil Bumi',
    role: 'Relay',
    riskScore: 78,
    connectedAccounts: 4,
    totalInflow: 950000000,
    totalOutflow: 920000000,
    holdingTime: '12.4 menit',
    ipAddress: '180.252.88.19 (Medan)',
    deviceId: 'DEV-44102-ANDROID13',
    txCount: 19,
    status: 'monitored',
    detectedDate: '2026-05-27',
    strStatus: 'Dalam Pemantauan FDS',
    linkedCryptoWallets: ['0xcdef...gh56 (Bybit)']
  },
  {
    id: 'MULE-005',
    name: 'Siti Rahmawati',
    alias: 'Karyawan Swasta (Nominee)',
    account: '2210987654',
    bank: 'CIMB',
    branch: 'KC Semarang Pandanaran (0034)',
    nik: '3374025509930005',
    npwp: '88.123.456.7-508.000',
    address: 'Jl. Pandanaran No. 56, Semarang Tengah, Semarang',
    job: 'Staf Admin (Pinjam Nama)',
    role: 'Penampung Utama',
    riskScore: 94,
    connectedAccounts: 9,
    totalInflow: 5400000000,
    totalOutflow: 5280000000,
    holdingTime: '1.8 menit (Bot Automated)',
    ipAddress: '118.99.102.44 (Jakarta Pusat)',
    deviceId: 'DEV-77219-ANDROID14',
    txCount: 54,
    status: 'active',
    detectedDate: '2026-05-23',
    strStatus: 'Rekomendasi Blokir Segera',
    linkedCryptoWallets: ['0xefgh...ij90 (Indodax)', '0xklmn...op12 (Binance)']
  },
  {
    id: 'MULE-006',
    name: 'Budi Prasetyo',
    alias: 'CV Sentosa Abadi',
    account: '6650321987',
    bank: 'BCA',
    branch: 'KC Tangerang Karawaci (0078)',
    nik: '3671041206880004',
    npwp: '31.456.789.0-411.000',
    address: 'Jl. Boulevard Diponegoro No. 105, Karawaci, Tangerang',
    job: 'Pengusaha Konstruksi',
    role: 'Kolektor',
    riskScore: 85,
    connectedAccounts: 6,
    totalInflow: 1800000000,
    totalOutflow: 1750000000,
    holdingTime: '8.7 menit',
    ipAddress: '139.192.210.15 (Tangerang)',
    deviceId: 'DEV-33201-WIN11',
    txCount: 28,
    status: 'monitored',
    detectedDate: '2026-05-26',
    strStatus: 'Dalam Pemantauan FDS',
    linkedCryptoWallets: ['0xqrst...uv34 (OKX)']
  },
  {
    id: 'MULE-007',
    name: 'Eko Wijaya',
    alias: 'Perorangan (Freelancer)',
    account: '4430567891',
    bank: 'Mandiri',
    branch: 'KC Yogyakarta Malioboro (0051)',
    nik: '3471012804950003',
    npwp: '92.345.678.1-541.000',
    address: 'Jl. Malioboro No. 34, Danurejan, Yogyakarta',
    job: 'Mahasiswa / Freelancer',
    role: 'Relay',
    riskScore: 82,
    connectedAccounts: 3,
    totalInflow: 780000000,
    totalOutflow: 760000000,
    holdingTime: '15.3 menit',
    ipAddress: '182.253.99.12 (Yogyakarta)',
    deviceId: 'DEV-55410-ANDROID13',
    txCount: 15,
    status: 'active',
    detectedDate: '2026-05-28',
    strStatus: 'Proses Review Analis',
    linkedCryptoWallets: ['0xwxyz...ab56 (Indodax)']
  }
];

// ==========================================
// GNN Graph Topological Data
// ==========================================
export const gnnGraphData = {
  nodes: [
    // Bank accounts (source)
    { id: 'N1', label: 'PT Mitra Sejahtera', type: 'bank', bank: 'BCA', riskScore: 92, x: 65, y: 110 },
    { id: 'N2', label: 'Perusahaan Maju', type: 'bank', bank: 'Mandiri', riskScore: 76, x: 65, y: 230 },
    { id: 'N3', label: 'Suryadi Kusumah', type: 'bank', bank: 'BRI', riskScore: 88, x: 65, y: 350 },
    // Mule accounts (intermediary)
    { id: 'N4', label: 'Bambang Haryanto', type: 'mule', bank: 'BCA', riskScore: 96, x: 230, y: 70 },
    { id: 'N5', label: 'Dewi Kartika', type: 'mule', bank: 'Mandiri', riskScore: 89, x: 230, y: 180 },
    { id: 'N6', label: 'Rahmat Hidayat', type: 'mule', bank: 'BRI', riskScore: 91, x: 230, y: 290 },
    { id: 'N7', label: 'Siti Rahmawati', type: 'mule', bank: 'CIMB', riskScore: 94, x: 230, y: 400 },
    // Crypto wallets
