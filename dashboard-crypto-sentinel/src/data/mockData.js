...
export const recentTransactions = [
  {
    id: 'TXN-2026-00891',
    timestamp: '2026-08-30 07:45:23',
    senderName: 'Billy Jonathan',
    senderAccount: '1234567890',
    senderBank: 'Bank Kuningan',
    amount: 750000000,
    destinationType: 'Crypto Exchange',
    destination: 'PT Binance Exchange Indonesia',
    walletAddress: '0x1a2b3c4d5e6f7890abcdef1234567890abcd1234',
    riskScore: 95,
    status: 'blocked',
    reason: 'Pola Smurfing Beruntun & Aliran Dana ke VASP Kripto',
    flaggedRules: ['VASP Crypto Outflow', 'Smurfing / Structuring', 'Drain to Zero'],
  },
  {
    id: 'TXN-2026-00890',
    timestamp: '2026-08-30 07:32:11',
    senderName: 'Rifki Firmansyah',
    senderAccount: '0123456789',
    senderBank: 'Bank bjb',
    amount: 150000000,
    destinationType: 'Crypto Exchange',
    destination: 'PT Indodax Nasional Indonesia',
    walletAddress: '0xabcdef1234567890abcdef1234567890abcd5678',
    riskScore: 78,
    status: 'flagged',
    reason: 'Transfer nominal besar ke Virtual Asset Service Provider',
    flaggedRules: ['High Amount Outflow', 'Crypto VASP Whitelist Review'],
  },
  {
    id: 'TXN-2026-00889',
    timestamp: '2026-08-30 07:28:05',
    senderName: 'Desta Erlangga',
    senderAccount: '1122334455',
    senderBank: 'Bank bjb',
    amount: 25000000,
    destinationType: 'Transfer Bank',
    destination: 'Rifki Firmansyah (Bank bjb)',
    walletAddress: null,
    riskScore: 12,
    status: 'approved',
    reason: null,
  ...
  {
    id: 'TXN-2026-00888',
    timestamp: '2026-08-30 07:15:44',
    senderName: 'Siti Rahma',
    senderAccount: '9876543210',
    senderBank: 'Bank Kuningan',
    amount: 500000000,
    destinationType: 'Crypto Exchange',
    destination: 'PT Tokocrypto Indonesia',
    walletAddress: '0x9876543210fedcba9876543210fedcba98765432',
    riskScore: 88,
    status: 'blocked',
    reason: 'Melebihi batas harian transfer APEX & terindikasi Mule Ring',
    flaggedRules: ['Daily Limit Exceeded', 'Mule Ring (GNN)', 'Rapid Structuring'],
  },
  {
    id: 'TXN-2026-00887',
    timestamp: '2026-08-30 07:05:12',
    senderName: 'Aam Setiana',
    senderAccount: '5544332211',
    senderBank: 'Bank Mandiri',
    amount: 85000000,
    destinationType: 'Transfer Bank',
    destination: 'Billy Jonathan (Bank Kuningan)',
    walletAddress: null,
    riskScore: 35,
    status: 'approved',
    reason: null,
  ...
  {
    id: 'TXN-2026-00886',
    timestamp: '2026-08-30 06:55:33',
    senderName: 'Budi Santoso',
    senderAccount: '8820192831',
    senderBank: 'Bank Central Asia (BCA)',
    amount: 10000000,
    destinationType: 'Transfer Bank',
    destination: 'Desta Erlangga (Bank bjb)',
    walletAddress: null,
    riskScore: 8,
    status: 'approved',
    reason: null,
  ...
  {
    id: 'TXN-2026-00885',
    timestamp: '2026-08-30 06:42:18',
    senderName: 'Billy Jonathan',
    senderAccount: '1234567890',
    senderBank: 'Bank Kuningan',
    amount: 350000000,
    destinationType: 'Crypto Exchange',
    destination: 'Indodax Fraud Receiver',
    walletAddress: '0x1234abcd5678efgh9012ijkl3456mnop7890qrst',
    riskScore: 92,
    status: 'blocked',
    reason: 'Rekening penerima masuk dalam Watchlist Densus Keuangan PPATK',
    flaggedRules: ['Threat Intel Blacklist', 'VASP Crypto Outflow', 'Drain to Zero'],
  },
  {
    id: 'TXN-2026-00884',
    timestamp: '2026-08-30 06:30:55',
    senderName: 'Rifki Firmansyah',
    senderAccount: '0123456789',
    senderBank: 'Bank bjb',
    amount: 200000000,
    destinationType: 'Crypto Exchange',
    destination: 'PT Pintu Kemakmuran Bersama',
    walletAddress: '0xabcd1234efgh5678ijkl9012mnop3456qrst7890',
    riskScore: 68,
    status: 'flagged',
    reason: 'Transfer APEX antar-bank ke bursa kripto berlisensi Bappebti',
    flaggedRules: ['APEX Gateway Layering', 'Medium Amount Review'],
  },
];
...
export const alertFeed = [
  {
    id: 1,
    type: 'critical',
    title: 'Smurfing & Crypto Outflow',
    description: 'Billy Jonathan (Bank Kuningan 1234****90) memecah dana ke Binance. Total: Rp 750 Juta dicegah oleh Circuit Breaker.',
    time: '2 menit lalu',
  },
  {
    id: 2,
    type: 'critical',
    title: 'Mule Ring Blacklist Match',
    description: 'Siti Rahma (Bank Kuningan 9876****10) transfer Rp 500 Juta ke Tokocrypto terindikasi klaster anomali GNN.',
    time: '15 menit lalu',
  },
  {
    id: 3,
    type: 'warning',
    title: 'Aliran Dana APEX Terpantau',
    description: 'Rifki Firmansyah (Bank bjb 0123****89) mengirim Rp 150 Juta ke Indodax dalam peninjauan analis OJK.',
    time: '28 menit lalu',
  },
  {
    id: 4,
